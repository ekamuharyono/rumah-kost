...
const Card = (props) => {
  ...
  return (
    <div className={styles.cardBox}>
      ...
      {props.type == 'action' ? <p className={styles.cardBayarButton}><p onClick={perpanjang} className='border w-max rounded-2xl text-sm px-3 font-normal -ml-3 py-1 hover:bg-green-300 hover:shadow duration-100 cursor-pointer'>Perpanjang</p></p> : <p className={styles.cardDate}>Jun 21, 2022</p>}
